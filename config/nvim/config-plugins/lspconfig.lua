...
local on_attach = function(client, bufnr)
  -- in null-ls client.resolved_capabilities.document_formatting = false
  -- in null-s client.resolved_capabilities.document_range_formatting = false
...
nvim_lsp.sumneko_lua.setup {
  ...
  cmd = {
    ...
    "/home/jkarng/Git/lua-language-serv/pkg/lua-language-server/usr/share/lua-language-server/main.lua"
  },
  filetypes = {"lua"},
  log_level = 2,
  root_dir = nvim_lsp.util.root_pattern(".git"),
...
nvim_lsp.hls.setup {
  ...
  -- lspinfo = <function 1>
  root_dir = nvim_lsp.util.root_pattern("*.cabal", "stack.yaml", "cabal.project", "package.yaml",
                                        "hie.yaml"),
