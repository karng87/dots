...
U.map('n', '<leader>sf', ':winc _<cr>:winc |<CR>')
U.map('i', '<leader>sf', '<ESC><c-u>:winc _<cr>:winc |<CR>')
U.map('t', '<leader>sf', [[<c-\><c-n>:winc _<cr>:winc |<CR>]])
U.map('n', '<leader>se', ':winc =')
U.map('i', '<leader>se', '<ESC><c-u>:winc =')
U.map('t', '<leader>se', [[<c-\><c-n>:winc =]])

U.map('n', '<leader>n', ':botright new')
U.map('i', '<leader>n', '<ESC>:botright new')
U.map('t', '<leader>n', [[<c-\><c-n>:botright new]])
U.map('n', '<leader>v', ':botright vnew')
U.map('i', '<leader>v', '<ESC>:botright vnew')
...
U.map('n', '<leader>cw', ':winc<space>')
U.map('i', '<leader>cw', '<esc>:winc<space>')
U.map('t', '<leader>cw', [[<c-\><c-n>:winc<space>]])

--
U.map('i', '<leader>nh', '<ESC>:set hlsearch!<CR>')
U.map('n', '<leader>nh', ':set hlsearch!<CR>')
U.map('t', '<leader>nh', [[<c-\><c-n>:set hlsearch!<CR>]])
--
-- return nmap
