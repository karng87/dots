...
vim.g.mapleader = ','
   ...
   U.map('s', [[<leader>e]], [[<ESC>:q<cr>]])
   U.map('x', [[<leader>e]], [[<ESC>:q<cr>]])


   U.map('i', [[<c-j>]], [[pumvisible() ? "\<C-n>" : "\<Tab>"]], true)
   U.map('i', [[<c-k>]], [[pumvisible() ? "\<C-p>" : "\<S-Tab>"]], true)
   U.map('i', [[<cr>]], [[pumvisible() ? "\<C-y>" : "\<cr>"]], true)
   U.map('c', [[<c-j>]], [[pumvisible() ? "\<C-n>" : "\<Tab>"]], true)
   U.map('c', [[<c-k>]], [[pumvisible() ? "\<C-p>" : "\<S-Tab>"]], true)
