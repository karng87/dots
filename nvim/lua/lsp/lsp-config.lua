...
local on_attach_config = function(client, bufnr)
 ...
 vim.api.nvim_buf_set_keymap(bufnr, 'i','<leader>gg','<cmd>lua vim.lsp.buf.declaration()<CR>', opts)
 ...
 vim.api.nvim_buf_set_keymap(bufnr, 'i','<leader>gcd','<cmd>lua vim.lsp.buf.document_symbol()<CR>', opts)
 vim.api.nvim_buf_set_keymap(bufnr, 'i','<leader>dw','<cmd>lua vim.lsp.buf.workspace_symbol()<CR>', opts)
  -- ACTION mappings
