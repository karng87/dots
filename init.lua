...
vim.api.nvim_set_keymap('n', '<leader>n', ':botright new', {noremap=true, silent=true})
vim.api.nvim_set_keymap('i', '<leader>n', '<ESC>:botright new', {noremap=true, silent=true})
vim.api.nvim_set_keymap('t', '<leader>n', '<c-\\><c-n>:botright new', {noremap=true, silent=true})
