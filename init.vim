...
nnoremap <leader>m <ESC>:new term://bash<cr>icd build && make -j4<cr>
inoremap <leader>m <ESC>:new term://bash<cr>icd build && make -j4<cr>
tnoremap <leader>m <c-u>cd build && make -j4<cr>

noremap <leader>1 <ESC>:new $th/term.md<cr>
noremap <leader>2 <ESC>:new $nh/init.vim<cr>
noremap <leader>3 <ESC>:new ~/.bashrc<cr>
noremap <leader>s <ESC>:w<cr>:so %<cr>
inoremap <leader>1 <ESC>:new $th/term.md<cr>
inoremap <leader>2 <ESC>:new $nh/init.vim<cr>
inoremap <leader>s <ESC>:so %<cr>
tnoremap <leader>1 <c-\><c-n>:new $th/term.md<cr>
tnoremap <leader>2 <c-\><c-n>:new $nh/init.vim<cr>
set nu rnu
